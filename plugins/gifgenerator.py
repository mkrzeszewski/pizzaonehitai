...
SLOT_IMAGES = ["assets/gif/pizza.png", "assets/gif/burger.png", "assets/gif/cs.png", "assets/gif/skull.png", "assets/gif/drink.png"]
...
def create_slot_machine_gif(output_path, frames=60, step=5, size=(300, 300)):
