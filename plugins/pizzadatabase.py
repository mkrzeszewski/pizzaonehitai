...
stockHistoryCollection = db['stock_history']
...
def updateStocksLastPrice(name, price):
...
def retrieveEventFromTheatre(theatre, title):
    return eventsCollection.find_one({"teatr": theatre, "title": title}, {"_id": 0, "name":1})
