...
def generateBirthdayEmbed(user, facts, wrozba):
    ...
    embed = Embed(title="Dzis sa twoje urodziny, " + user['name'] + "!", description = PEPE_BIRTHDAY_EMOTE + " " + str(bdayPhrases[random.randint(0,len(bdayPhrases) - 1)]['phrase']), color=Colour.pink())
